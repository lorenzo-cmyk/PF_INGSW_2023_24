...
class DeckTypeTest {
    ...
    void getJSONPathForResourceDeck() {
        String expectedPath = "/it/polimi/ingsw/am32/model/deck/ResourceCards.json";
    ...
    void getJSONPathForGoldDeck() {
        String expectedPath = "/it/polimi/ingsw/am32/model/deck/GoldCards.json";
    ...
    void getJSONPathForStartingDeck() {
        String expectedPath = "/it/polimi/ingsw/am32/model/deck/StartingCards.json";
    ...
    void getJSONPathForObjectiveDeck() {
        String expectedPath = "/it/polimi/ingsw/am32/model/deck/ObjectiveCards.json";
